...
""").split("\n")
    ...
    try:
        ...
        url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"KnightSpy"+Fore.BLUE+"~"+Fore.WHITE+"snehraval"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Plugins"+Fore.RED+"""]
 └──╼ $ """).lower()
        if url == "" or None:
...
def user():
    try:
        print(Fore.GREEN+" [+] Please Enter WordPress URL\n")
        print(Fore.RED+" [!] Please Do Not Include Http\n")
        Url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"KnightSpy"+Fore.BLUE+"~"+Fore.WHITE+"snehraval"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Username"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ").lower()
