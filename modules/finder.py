...
def __start__():
    try:
        ...
        url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"KnightSpy"+Fore.BLUE+"~"+Fore.WHITE+"snehraval"+Fore.RED+"/"+Fore.CYAN+"IG"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"Admin-Finder"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ")
