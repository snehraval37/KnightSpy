...
def __start__():
    try:
        ...
        url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"KnightSpy"+Fore.BLUE+"~"+Fore.WHITE+"snehraval"+Fore.RED+"/"+Fore.CYAN+"IG"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"Robots_Scanner"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"$ ")
        if 'http' in url:
            pass
        elif 'http' != url:
